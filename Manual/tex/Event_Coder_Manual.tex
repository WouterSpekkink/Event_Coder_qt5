...
You should also notice two small text fields on the left and right sides of the screen, with \textbf
{Prev.} and \textbf{Next} buttons on both sides of the fields (see figure \ref{fig:filternavigate}). If you type something in one of these fields and then click \textbf{Prev.} or \textbf{Next}, then the program will jump to the previous/next incident that contains this text in the column that is currently being inspected. For example, in the situation shown in figure \ref{fig:filternavigate}, if we would now click the \textbf{Next} button on the right side of the screen, the program will jump to the next incident that contains the word ``dog'' somewhere in the \emph{Description} column of the data set.


\begin{figure}[h!]
  \centering
  \caption{Navigation based on text.}
  \includegraphics[width=100mm]{Screenshot_29.pdf}
  \label{fig:filternavigate}
\end{figure}

There are two other, special ways to navigate through your data, which only become available once you have coded your data. These are discussed in chapter \ref{chap:usingtheprogram2}. 
...
\subsection{Navigating incidents based on attributes}
\label{sec:navigatingattributes}

Once you have started assigning attributes to incidents, it is also possible to jump between different incidents based on the attributes assigned to them. Once you click an attribute in the list of \textbf{Incident attributes} or in the \textbf{Attribute pool}, two additional buttons will be activated (see figure \ref{fig:navigatingattributes}), which allow you to jump to the previous or the next incident that has the currently selected attribute assigned to it. 

\begin{figure}[h!]
  \centering
  \caption{Navigating incidents based on attributes.}
  \includegraphics[width=100mm]{Screenshot_27.pdf}
  \label{fig:navigatingattributes}
\end{figure}
...
\subsection{Navigating incidents based on relationships}
\label{sec:navigatingrelationships}

Once you have started assigning relationships to incidents, it is also possible to jump between different incidents based on the relationships assigned to them. Once you click a relationship in the list of \textbf{Indicated relationships} or in the \textbf{Relationship pool}, two additional buttons will be activated (see figure \ref{fig:navigatingrelationships}), which allow you to jump to the previous or the next incident that has the currently selected relationship assigned to it. 

\begin{figure}[h!]
  \centering
  \caption{Navigating incidents based on relationships.}
  \includegraphics[width=100mm]{Screenshot_28.pdf}
  \label{fig:navigatingrelationships}
\end{figure}
