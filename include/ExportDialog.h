...
public:
  ExportDialog(QWidget *parent=0, DataInterface *interface = new DataInterface);
  ~ExportDialog() {};
...
private:
  ...
  QPointer<QLabel> incidentOthersLabel;
  QPointer<QLabel> relationshipsLabel;
  
  QVector<QPointer<QCheckBox> > incidentPropertiesVector;

  QPointer<QCheckBox> incidentAttributesCheckBox;
  QPointer<QCheckBox> incidentCategoriesCheckBox;
  QPointer<QCheckBox> includeIncidentPropertiesCheckBox;
  QPointer<QCheckBox> relationshipsCheckBox;
  QPointer<QCheckBox> includeEntityPropertiesCheckBox;
  QPointer<QCheckBox> entityAttributesCheckBox;
  QPointer<QCheckBox> entityCategoriesCheckBox;
